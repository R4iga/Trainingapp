...
void main() {
  ...
  testWidgets('profile draws without blowing up', (tester) async {
  ...
  testWidgets('groups draws without blowing up', (tester) async {
    await visit(tester, 'groups');
  });

  testWidgets('feed draws without blowing up', (tester) async {
    await visit(tester, 'feed');
  });
